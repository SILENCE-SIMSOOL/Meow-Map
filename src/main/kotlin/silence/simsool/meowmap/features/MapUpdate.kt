...
import silence.simsool.meowmap.utils.MapUtils.mapX
import silence.simsool.meowmap.utils.MapUtils.mapZ
import silence.simsool.meowmap.utils.MapUtils.yaw
    ...
    private fun getConnectedIndices(arrayX: Int, arrayY: Int): List<Pair<Int, Int>> {
        ...
        while (queue.isNotEmpty()) {
            ...
            directions.forEach {
                ...
                if (Dungeon.Info.dungeonList[y * 11 + x] is Room) queue.add(Pair(x, y))
            }
        }
        return connected
    }
