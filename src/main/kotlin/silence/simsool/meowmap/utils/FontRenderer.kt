...
import silence.simsool.meowmap.utils.RenderUtilsGL.bind
import java.awt.Color
import java.awt.image.BufferedImage
import java.io.IOException
import kotlin.math.max

object FontRenderer : IResourceManagerReloadListener {
    ...
    fun drawString(text: String, x: Float, y: Float, color: Color, dropShadow: Boolean): Int {
        ...
        } else i = renderString(text, x, y, color, false)
    ...
    private fun renderString(text: String, x: Float, y: Float, color: Color, dropShadow: Boolean): Int {
        ...
        } else GL11.glColor4f(color.red / 255f, color.green / 255f, color.blue / 255f, color.alpha / 255f)
        posX = x
        posY = y
    ...
    fun getCharWidth(character: Char): Int {
        ...
        if (character > '\u0000' && i != -1) return charWidth[i]
        return 0
    }
}
